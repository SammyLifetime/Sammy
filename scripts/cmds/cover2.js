...
module.exports = {
    ...
    try {
      ...
      return;
        ...
        const img = (`https://www.nguyenmanh.name.vn/api/avtWibu4?id=${id1}&tenchinh=${name}&fb=${juswa}&tenphu=${bgtext}&apikey=zrAM6vv6`)			
                 const form = {
       ...
       await message.reply("processing your cover please wait....");
         ...
         const img = (`https://www.nguyenmanh.name.vn/api/avtWibu4?id=${id}&tenchinh=${name}&fb=${juswa}&tenphu=${bgtext}&apikey=zrAM6vv6`)			
                 const form = {
				body: `your cover is here boss`
			};
				form.attachment = []
