...
Game intro :- this a simple memory test game where you have to remeber emoji place behind cards and reveal it by using moves like a1 a2 b1 a3 like this.
...
when you type a1 b1 the emoji behind them will get reveal and if the emoji are same than you have use another move in case of emoji doesnt match you have 5 seconds to remember it and bot will unsend the message and send another board for you to use another move the game wil continue until you find all the pair emoji behind cards.
