...
module.exports = {
  ...
  onStart: async function({ api, args, message, event }) {
    ...
    if (args[0] === "approve" && args[1]) {
      ...
      message.reply(`╔════ஜ۩۞۩ஜ═══╗\n\nInvalid command usage. Use "help main" to see how to use this command.\n\n╚════ஜ۩۞۩ஜ═══╝`);
    }
  },
};
